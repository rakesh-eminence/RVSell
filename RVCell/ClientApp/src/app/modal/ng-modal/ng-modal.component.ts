...
export class ModalComponent implements OnInit, AfterViewChecked {
  ...
  @Input() modalTitle: string = "Property view";
  @Input() width: any;
  ...
  @Input() display: string = 'contents';
  @Input() top: string = "30px"

  constructor(private element: ElementRef, private ngZone: NgZone, private dataSharingservice: DataSharingservice, public globals: Globals) {
  ...
  hide(): void {
    ...
    this.focusLastModal();
    this.dataSharingservice.insertModelunitDataClear();
    this.removeEventListener();
    this.globals.modelClose = 0;
  ...
  center() {
    ...
    if (elementWidth === 0 && elementHeight === 0) {
      ...
      this.modalRoot.nativeElement.style.display = 'contents';
  ...
  focusLastModal() {
    const modal = this.findAncestor(this.element.nativeElement, 'app-ng-modal');
  ...
  toggleMin() {
    var $apnData = $('.ui-modal').closest(".mymodal")
    var $modal = "#modal-2";
